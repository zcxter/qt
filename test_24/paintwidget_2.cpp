...
PaintWidget_2::PaintWidget_2(QWidget *parent) : QWidget(parent)
{
    this->resize(800,800);
...
void PaintWidget_2::refreshPixmap()
{
    int i=0,w=1;
    ...
    lineStart.setY((round((double)pix_->height()/2 - (((double)wavaData[ecgWaveIndex] - 2048)/600 * pix_->height()/2)))/5);
    ...
    lineEnd.setY((round((double)pix_->height()/2 - (((double)wavaData[ecgWaveIndex] - 2048)/600 * pix_->height()/2)))/5);
...
void PaintWidget_2::paintEvent(QPaintEvent *event)
{
